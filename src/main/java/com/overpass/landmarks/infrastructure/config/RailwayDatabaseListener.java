...
/**
 * Application listener that parses Railway's DATABASE_URL environment variable
 ...
 */
public class RailwayDatabaseListener implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {

    private static final Logger logger = LoggerFactory.getLogger(RailwayDatabaseListener.class);
